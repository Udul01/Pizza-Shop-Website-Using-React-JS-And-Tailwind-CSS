...
const MenuCard = ({ id, img, title,description, price }) => {
  return (
    <div
    ...
    >
      ...
      <div className=" space-y-4">
        <h3 className=" font-bold text-center text-2xl pt-3 pt-7">{title}</h3>
        <p className=" text-center">
          {description}
        </p>
        <div className=" flex flex-row items-center justify-center gap-4 pb-2 pb-7">
